Feature: GitHub plugin — event-invalidated caching proxy
  ...
  Scenario: Production LOC for the github plugin stays within the 1540-line budget
    ...
    Then the count is 1540 or fewer
    And evidence is captured: "plugins/github prod LOC <= 1540, via make loc-github output"
