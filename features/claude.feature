Feature: Claude plugin — session state from lifecycle hooks + transcript tail
  ...
  Scenario: Production LOC for the claude plugin stays within the 720-line budget
    ...
    Then the count is 720 or fewer
  ...
  # AC-CLAUDE-LOC             → prod LOC <= 720 (measured 677 + 5% headroom)
